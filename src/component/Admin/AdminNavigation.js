...
<Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" mr= "auto" >
  ...
  <Nav className="justify-content-end" style={{ width: "93%" }}>
      ...
      <NavDropdown title="Labels" id="collasible-nav-dropdown" >
        <NavDropdown.Item href="admin-show-label">View Labels</NavDropdown.Item>
        <NavDropdown.Item href="admin-add-label">Create Labels</NavDropdown.Item>
      </NavDropdown>
      ...
      <NavDropdown title="Campaigns " id="collasible-nav-dropdown" >
        <NavDropdown.Item href="campaign">View Campaigns</NavDropdown.Item>
        <NavDropdown.Item href="add-campaign">Add Campaign</NavDropdown.Item>
      </NavDropdown>
